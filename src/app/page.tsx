...
import { Fish, Headphones, Leaf, Map, Sparkles } from "lucide-react";
...
export default function LandingPage() {
  ...
  <div id="home" data-section="home">
      ...
      testimonials={[
        ...
        {
          name: "Elena P.",
          handle: "@elena_explorer",
          testimonial: "The tranquil waters and lush landscapes were exactly what I needed. Pure bliss!",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/high-angle-woman-walking-through-foliage_23-2148357663.jpg",
        },
        {
          name: "James K.",
          handle: "@james_escapes",
          testimonial: "From sunrise yoga to sunset cruises, every detail was perfect. A truly memorable experience.",
          rating: 5,
        ...
        },
        {
          name: "Olivia M.",
          handle: "@olivia_calm",
          testimonial: "I found true peace here. The ambiance is incredibly soothing, and the staff are wonderful.",
          rating: 5,
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/man-black-wooden-jetty-maldives_505751-5527.jpg",
          alt: "Mark D.",
        },
        {
          src: "http://img.b2bpic.net/free-photo/portrait-beautiful-cute-smiling-blond-teenager-model-without-makeup-summer-hipster-white-dress-posing-street-background-touching-her-face_158538-12845.jpg",
          alt: "Elena P.",
        },
        {
          src: "http://img.b2bpic.net/free-photo/portrait-smiling-bearded-man-drinking-coffee_171337-12821.jpg",
          alt: "James K.",
        },
        {
          src: "http://img.b2bpic.net/free-photo/happy-handsome-man-posing_23-2148911846.jpg",
          alt: "Liam S.",
        },
      ]}
  ...
  <div id="about" data-section="about">
      ...
      description="The Lagoon is more than just a destination—it's a sanctuary. A place where the pristine waters reflect the boundless sky, and lush landscapes whisper ancient tales. We invite you to experience a harmonious blend of luxurious comfort and untouched nature, fostering moments of profound peace and exhilarating discovery. Our commitment to preserving this natural wonder ensures its splendor for generations to come."
    />
  </div>
      ...
      features={[
        {
          ...
          description: "Dive into the crystal-clear waters with exhilarating activities. Explore vibrant marine life and hidden coves.",
          media: {
            imageSrc: "http://img.b2bpic.net/free-photo/long-shot-man-holding-surfboard_23-2148926823.jpg",
            imageAlt: "Kayaking in a clear lagoon",
          },
          items: [
            {
              icon: Kayak,
        ...
        },
        {
          ...
          description: "Rejuvenate your mind, body, and soul amidst the tranquil beauty of The Lagoon. Find your inner peace.",
          media: {
            imageSrc: "http://img.b2bpic.net/free-photo/portrait-beautiful-young-asian-woman-relax-smile-leisure-around-outdoor-swimming-pool-nearly-sea_74190-14048.jpg",
            imageAlt: "Woman practicing yoga on a beach at sunset",
          },
          items: [
            {
              icon: Lotus,
        ...
        },
        {
          ...
          description: "Discover the lush landscapes and hidden wonders surrounding The Lagoon. Connect with untouched nature.",
          media: {
            imageSrc: "http://img.b2bpic.net/free-photo/beautiful-shot-rocky-beach-sunset_181624-29138.jpg",
            imageAlt: "Tropical forest trail",
          },
          items: [
            {
              icon: Leaf,
      ...
      products={[
        {
          ...
          name: "Azure Waters",
          price: "Explore",
          imageSrc: "http://img.b2bpic.net/free-photo/sea-vacations-green-water-waves_1122-2274.jpg",
          imageAlt: "Aerial view of clear azure lagoon waters",
        },
        {
          id: "g2",
          name: "Vibrant Reefs",
          price: "Discover",
          imageSrc: "http://img.b2bpic.net/free-photo/vivid-colours-plants-natural-environment_23-2151357910.jpg",
          imageAlt: "Underwater view of a colorful coral reef",
        },
        {
          id: "g3",
          name: "Overwater Retreat",
          price: "Indulge",
          ...
          imageAlt: "Luxury overwater bungalows at sunset",
        },
        {
          id: "g4",
          name: "Golden Hour",
          price: "Experience",
          imageSrc: "http://img.b2bpic.net/free-photo/landscape-with-sea-sunset-beach_93675-128300.jpg",
          imageAlt: "Sunset over the tranquil lagoon",
        },
        {
          id: "g5",
          name: "Lush Greenery",
          price: "Connect",
          imageSrc: "http://img.b2bpic.net/free-photo/vertical-shot-green-plants-growing-forest_181624-28505.jpg",
          imageAlt: "Dense tropical jungle foliage",
        },
        {
          id: "g6",
          name: "Secluded Sands",
  ...
  <div id="social-proof" data-section="social-proof">
      ...
      names={[
        ...
        "Eco Resorts International",
        "Adventure Seekers Guild",
        "Wellness Retreats Global",
        "Nature Conservancy Partners",
        "Marine Life Institute",
        "Coastal Living Journal",
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "faq1",
          title: "What types of accommodation are available?",
          content: "The Lagoon offers a range of luxurious accommodations, including overwater bungalows, private beach villas, and secluded garden suites, each designed to provide ultimate comfort and stunning views.",
        },
        {
          id: "faq2",
          title: "What activities can I enjoy at The Lagoon?",
          content: "Our diverse activities include guided kayaking, snorkeling and diving, beachside yoga, spa treatments, nature walks, wildlife spotting, and island excursions. There's something for every interest.",
        },
        {
          id: "faq3",
          title: "Is The Lagoon suitable for families with children?",
          content: "Yes, The Lagoon is a family-friendly destination. We offer a variety of activities and amenities suitable for all ages, including a kids' club and dedicated family experiences. Please inquire for more details.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[
        ...
        {
          text: "Send an Email",
          href: "mailto:info@thelagoon.com",
        },
      ]}
    />
  </div>
